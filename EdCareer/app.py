...
st.set_page_config(
   page_title="EdCareer Bot",
   page_icon="https://i.ibb.co/1GwWqmc/favicon.png",
)
...
def main():
    ...
    qvals = {"Select an Option": 0, "Strongly Agree": 5, "Agree": 4, "Neutral": 3, "Disagree": 2,
             "Strongly Disagree": 1}
    st.title("EdCareer Bot")
    banner=Image.open("img/21.png")
    st.image(banner, use_column_width=True)
    st.write("Hi! I'm EdCareer Bot, your personal career counseling bot. Ask your queries in the text box below and hit enter. If and when you are ready to take our personality test, type \"start my test\" and you're good to go!")

    df3 = get_text()
    if (df3.loc[0, 'user']==""):
        ans = "Hi, I'm EdCareer Bot. \nHow can I help you?"
    ...
    st.text_area("EdCareer Bot:", value=ans, height=100, max_chars=None)
